...
namespace ProjektovanjeSoftvera.EkartaService {
    ...
    public partial class popustiResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="", Order=0)]
        public ProjektovanjeSoftvera.EkartaService.Application_Model_Popust[] @return;
        
        public popustiResponse() {
        }
        
        public popustiResponse(ProjektovanjeSoftvera.EkartaService.Application_Model_Popust[] @return) {
            this.@return = @return;
        }
    }
